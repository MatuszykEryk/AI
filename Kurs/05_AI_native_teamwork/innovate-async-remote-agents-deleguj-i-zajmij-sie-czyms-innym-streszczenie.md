...
Agent działa w świeżym środowisku chmurowym, klonuje repo, robi setup i pracuje po zamknięciu laptopa. Dobry model dla zadań typu: mała zmiana, PR i testy „na później”. Koszt: konfiguracja środowiska i zaufanie do sandboxa dostawcy.
